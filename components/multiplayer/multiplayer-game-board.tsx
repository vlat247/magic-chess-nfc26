        ...
        <div className="relative border-4 border-[oklch(0.2_0.04_280)]">
          <Chessboard
            ...
            options={{
              ...
              onPieceDrop,
              onSquareClick,
              lightSquareStyle: { backgroundColor: 'oklch(0.25 0.08 300)', boxShadow: 'inset 0 0 8px oklch(0.7 0.25 300 / 0.12)' },
              darkSquareStyle: { backgroundColor: 'oklch(0.15 0.04 280)' },
